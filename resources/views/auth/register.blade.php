...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-right  text-light" style="background-color: #1e8574;"> <h2> <i class="fas fa-user-plus"></i> {{ __('تسجيل حساب  ') }}  </h2></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">المدينة</label>
